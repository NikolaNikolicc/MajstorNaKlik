...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 21, 2023 at 11:05 AM
...
--
-- Database: `majstornaklik_tests`
--
CREATE DATABASE IF NOT EXISTS `majstornaklik_tests` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci;
USE `majstornaklik_tests`;
...
(1, 'Test Factory', 'test001', 'Factories\\Tests\\NewFactory', 'fas fa-puzzle-piece', 'Longer sample text for testing', NULL, '2023-06-21 11:02:50', '2023-06-21 11:02:50'),
...
CREATE TABLE IF NOT EXISTS `migrations` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=370 DEFAULT CHARSET=utf8mb3;
...
(369, '2020-02-22-222222', 'Tests\\Support\\Database\\Migrations\\ExampleMigration', 'tests', 'Tests\\Support', 1687345370, 1);
